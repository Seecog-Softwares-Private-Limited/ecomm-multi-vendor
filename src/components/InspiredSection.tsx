        ...
        <div className="flex flex-nowrap gap-3 overflow-x-auto pb-2 sm:grid sm:grid-cols-5 sm:gap-6 sm:overflow-visible">
          {inspiredProducts.map((p, i) => (
            <Link
              key={i}
              href={p.href}
              className="min-w-[96px] overflow-hidden sm:min-w-0 block rounded-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FF6A00]"
